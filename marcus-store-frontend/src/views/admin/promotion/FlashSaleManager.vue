        ...
        <div class="table-responsive">
          <table class="table align-middle fs-table mb-0">
            ...
            <tr>
              ...
              <th class="text-center fs-th-w100">Thao tác</th>
            </tr>
            </thead>
            <tbody>
            <tr v-for="slot in filteredSlots" :key="slot.slotId">
              ...
              <td>
                <div class="fs-time-line">
                  <div><span class="fs-label">Từ</span><span>{{ formatDateTime(slot.startDate) }}</span></div>
                  <div><span class="fs-label">Đến</span><span>{{ formatDateTime(slot.endDate) }}</span></div>
                </div>
              </td>
              ...
              <td class="text-center">
                <button class="fs-icon-btn fs-icon-edit" title="Sửa" @click="openEditModal(slot)">
                  <i class="bi bi-pencil-square"></i>
                </button>
                <button class="fs-icon-btn fs-icon-del ms-1" title="Xóa" @click="openDelModal(slot)">
    ...
    >
      <div class="fs-modal-box">
        <div class="fs-modal-hd">
          <h3>{{ isEditing ? 'Chỉnh sửa Flash Sale' : 'Tạo Flash Sale mới' }}</h3>
        ...
        <div class="fs-modal-body">
          ...
          <div class="fs-form-group">
            <label class="fs-form-label">Tên chiến dịch <span class="text-danger">*</span></label>
            <input
              v-model="form.name"
              type="text"
              class="fs-input"
          ...
          <div class="row g-3">
            <div class="col-6">
              <label class="fs-form-label">Thời gian bắt đầu <span class="text-danger">*</span></label>
              <input
            ...
            <div class="col-6">
              <label class="fs-form-label">Thời gian kết thúc <span class="text-danger">*</span></label>
              <input
                    ...
                    <div class="fs-cascade-right">
                      <template v-if="cascadeBrand">
                        <div class="fs-cascade-right-hd">
                          <strong>{{ BRAND_SERIES.find(x => x.key === cascadeBrand)?.label }}</strong>
                          <button
                            type="button"
                            ...
                            <div v-if="cascadeSeries === s" class="fs-cascade-items">
                              ...
                              >
                                <div class="fs-cascade-check">
                                  <i v-if="selectedItemPids.includes(p.id)" class="bi bi-check-lg"></i>
                                </div>
                  ...
                  <tr v-for="pid in selectedItemPids" :key="pid">
                    ...
                    <td>
                      <input
                        ...
                        min="0"
                      />
                      <div v-if="qtyError[pid]" class="fs-form-error">Quá tồn kho</div>
                    </td>
                    <td>
    ...
    >
      <div class="fs-del-box">
        ...
        <div class="fs-del-actions">
          <button type="button" class="fs-btn-white" @click="closeDelModal">Hủy bỏ</button>
...
function toggleActive(slot, checked) {
  ...
  if (idx !== -1) {
    ...
    showToast({ type: 'success', title: 'Thành công', message: checked ? 'Đã kích hoạt chiến dịch.' : 'Đã tắt chiến dịch.' })
  }
}
...
const PRODUCTS = [
  { id: 1, name: 'iPhone 15 Pro Max 256GB',   emoji: '📱', price: 34990000, stock: 50, brand: 'iphone',  categoryId: 1 },
  { id: 2, name: 'iPhone 15 Pro 128GB',       emoji: '📱', price: 27990000, stock: 30, brand: 'iphone',  categoryId: 1 },
  { id: 3, name: 'iPhone 14 Pro Max 256GB',   emoji: '📱', price: 28990000, stock: 25, brand: 'iphone',  categoryId: 1 },
  { id: 4, name: 'iPhone 14 128GB',           emoji: '📱', price: 19990000, stock: 40, brand: 'iphone',  categoryId: 1 },
  { id: 5, name: 'Samsung Galaxy S24 Ultra',  emoji: '📲', price: 29990000, stock: 30, brand: 'samsung', categoryId: 1 },
  { id: 6, name: 'Samsung Galaxy S24+',       emoji: '📲', price: 21990000, stock: 40, brand: 'samsung', categoryId: 1 },
  { id: 7, name: 'Samsung Galaxy A55',        emoji: '📲', price:  9990000, stock: 60, brand: 'samsung', categoryId: 1 },
  { id: 8, name: 'Xiaomi 14 Ultra',           emoji: '🖤', price: 22990000, stock: 45, brand: 'xiaomi',  categoryId: 1 },
  { id: 9, name: 'OPPO Find X7 Pro',          emoji: '🟢', price: 19990000, stock: 25, brand: 'oppo',    categoryId: 1 },
  { id: 10, name: 'Vivo X100 Pro',            emoji: '🔵', price: 17990000, stock: 60, brand: 'vivo',    categoryId: 1 },
  { id: 11, name: 'Google Pixel 8 Pro',       emoji: '🌈', price: 22990000, stock: 20, brand: 'google',  categoryId: 1 },
  { id: 12, name: 'Tai nghe Bluetooth AirPro', emoji: '🎧', price:  1490000, stock: 100, brand: 'iphone',  categoryId: 2 },
  { id: 13, name: 'Sac nhanh 65W Type-C',     emoji: '🔌', price:   590000, stock: 80, brand: 'samsung', categoryId: 2 },
  { id: 14, name: 'MacBook Air M3 13"',       emoji: '💻', price: 27990000, stock: 15, brand: 'iphone',  categoryId: 3 },
]

// Level-1 (parent) = Brand, Level-2 (child) = Series dẽ từ tên SP
const BRAND_SERIES = [
  { key: 'iphone',  label: 'iPhone',   icon: 'bi-apple',          series: ['iPhone 15 Series', 'iPhone 14 Series'] },
  { key: 'samsung', label: 'Samsung',  icon: 'bi-phone',          series: ['Galaxy S24 Series', 'Galaxy A Series'] },
...
function selectCategory(catId) {
  ...
  if (added > 0) {
    showToast({ type: 'success', title: 'Thành công', message: `Đã thêm ${added} sản phẩm từ danh mục.` })
  }
}
